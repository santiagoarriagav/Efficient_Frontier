...
import { PortfolioPoint, EfficientFrontierChartProps } from "@/types/portfolio";
...
export default function EfficientFrontierChart({ tickers }: EfficientFrontierChartProps) {
  const [frontierData, setFrontierData] = useState<PortfolioPoint[]>([]);
  const [selected, setSelected] = useState<PortfolioPoint | null>(null);
